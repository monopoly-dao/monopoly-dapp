      ...
      .catch((error) => {
        ...
        switch (errorCode) {
          case "auth/email-already-in-use":
            setError(
              "You already registered with this email address. Try logging in instead."
            );
            break;
          default:
            setError(errorCode);
      ...
      <div className={styles.signup}>
        ...
        <div className={styles.right}>
          ...
          <div className={styles.form}>
            ...
            />
            <Button type="contained" handleClick={handleSubmit}>
              Sign up
            </Button>
            <h4 className={styles.h5} onClick={gotoLogin}>
          ...
          <GoogleButton type="contained" handleClick={handleGoogleSignUp}>
