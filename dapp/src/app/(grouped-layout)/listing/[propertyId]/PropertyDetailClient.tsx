...
export default function PropertyDetailClient({ initialData }: { initialData?: Property }) {
            ...
            <div className='mt-8 sm:mb-32 px-[5%] sm:px-[7%] font-inter'>
                ...
                <div className='mt-12 mb-16 flex flex-col-reverse sm:flex-row w-full justify-between gap-5'>
                    <div className='w-full sm:w-3/5 flex flex-col gap-7'>
                                ...
                                <div className='flex items-center gap-1'>
                                    <p>
                                        <LoadingText
                                            isLoading={isLoading && !displayProperty}
                                            className='w-10'
                                            value={formatAmount(displayProperty?.propertyDetails.squareFt)}
                                        />{' '}
                                        sqft
                                    </p>
                                </div>
                        ...
                        <div className='h-[1px] w-full bg-settley-primary/5' />
                        <div className='flex flex-col gap-4'>
                            <p className='font-bold text-xl text-navy'>Asset Symbol</p>
                            <p className='font-bold text-2xl text-settley-primary'>
                                $
                                <LoadingText
                                    isLoading={isLoading && !displayProperty}
                                    className='w-10'
                        ...
                        <div className='flex flex-col gap-4'>
                            ...
                            <Link
                                ...
                                target='_blank'
                                className='text-settley-primary underline break-words font-medium hover:text-navy transition-colors'
                            >
                                <LoadingText
                                    isLoading={isLoading && !displayProperty}
                                    className='w-10'
                        ...
                        <div className='flex flex-col gap-4'>
                            ...
                            <div className='flex items-center gap-10 mt-2 text-lg text-settley-text font-medium'>
                                <div className='flex items-center gap-2'>
                                    <MdPool className='text-settley-primary' />
                                    <p>Pool</p>
                                </div>
                                <div className='flex items-center gap-2'>
                                    <MdPool className='text-settley-primary' />
                                ...
                                <div className='flex items-center gap-2'>
                                    <FaUmbrellaBeach className='text-settley-primary' />
                                    <p>Deck</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='flex flex-col gap-6 w-full sm:w-2/5 lg:w-1/4 bg-white p-8 rounded-2xl border border-settley-primary/5 shadow-sm h-fit'>
                        <div className='flex flex-col gap-1'>
                            <p className='text-4xl font-bold text-navy'>$1 <span className='text-sm font-medium text-settley-text/60'>/ UNIT</span></p>
                            <div className='text-sm font-medium text-settley-text/60 bg-settley-primary/5 py-1 px-3 rounded-full w-fit'>
                                {formatAmount(displayProperty?.propertyDetails.unitsLeft)} Units left
                            </div>
                        </div>
