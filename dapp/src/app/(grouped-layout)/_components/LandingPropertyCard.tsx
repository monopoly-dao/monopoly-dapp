            ...
            <div className='flex flex-col p-5 gap-4 flex-1'>
                ...
                {fundedPercentage !== undefined && (
                    <div className='flex flex-col gap-1.5'>
                        <div className='flex justify-between text-xs font-medium'>
                            <span className='text-settley-primary'>Funded</span>
                            <span>{fundedPercentage}%</span>
                        </div>
                        <div className='w-full h-2 bg-secondary/30 rounded-full overflow-hidden'>
                            <div
                                className='h-full bg-settley-primary rounded-full'
                ...
                <div className='flex items-end justify-between mt-auto pt-4 border-t border-gray-100'>
                    <div className='flex flex-col'>
                        ...
                        <span className='font-bold text-lg text-navy'>${formatAmount(property.propertyDetails.units)}</span>
                    </div>

                    <button className='bg-settley-primary text-white text-sm font-medium px-6 py-2.5 rounded-xl hover:bg-settley-primary/90 transition-colors'>
                        Buy Now
                    </button>
                </div>
            </div>
